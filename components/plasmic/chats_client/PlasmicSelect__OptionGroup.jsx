...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _XArMe1d9Uqxi-/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: DBaIAlzZ3jDAe1/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pc7O)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__gk0V8)}
              />
            </React.Fragment>
          ),
